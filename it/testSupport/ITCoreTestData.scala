...
trait ITCoreTestData extends TryValues {
  ...
  val userAnswersForPackagingSiteDetailsPage: Map[String, UserAnswers] = {
    val yesSelected = userAnswersWith1PackingSite
      .set(PackagingSiteDetailsPage, true)
      .success
      .value
      .copy(packagingSiteList = packagingSiteListWith1)
    val noSelected  = userAnswersWith1PackingSite
  ...
  val userAnswersForImportsPage: Map[String, UserAnswers] = {
    val yesSelected = emptyUserAnswers
      ...
      .success
      .value
      .set(HowManyImportsPage, LitresInBands(0, 0))
      .success
      .value
    val noSelected  = emptyUserAnswers
  ...
  val userAnswersForEnterBusinessDetailsPage = emptyUserAnswers
    .set(EnterBusinessDetailsPage, Identify("0000001611", "TF8 4FH"))
    .success
    .value
  ...
  def packagingSite1 = Site(UkAddress(List("33 Rhes Priordy", "East London"), "E73 2RP"), None, aTradingName, None)
  ...
  def packagingSiteListWith3 =
    Map(("12345678", address45Characters), ("23456789", address47Characters), ("34567890", address49Characters))
