...
trait RegSummaryISpecHelper extends ControllerITTestHelper {
  ...
  def userAnswerWithLitresForAllPagesIncludingOnesNotRequired(producerType: HowManyLitresGlobally) = emptyUserAnswers
    ...
    .success
    .value
    .set(HowManyLitresGloballyPage, producerType)
    .success
    .value
    .set(OperatePackagingSitesPage, true)
    .success
    .value
    .set(HowManyOperatePackagingSitesPage, operatePackagingSiteLitres)
    .success
    .value
    .set(ContractPackingPage, true)
    .success
    .value
    .set(HowManyContractPackingPage, contractPackingLitres)
    .success
    .value
    .set(ImportsPage, true)
    .success
    .value
    .set(HowManyImportsPage, importsLitres)
    .success
    .value
    ...
    .success
    .value
    .set(ContactDetailsPage, contactDetails)
    .success
    .value
  ...
  def userAnswerWithAllNoAndNoPagesToFilterOut(producerType: HowManyLitresGlobally) = {
    val uaThatAllPagesHave = emptyUserAnswers
      ...
      .success
      .value
      .set(AskSecondaryWarehousesPage, false)
      .success
      .value
    ...
    producerType match {
      case Large =>
        uaThatAllPagesHave
          .set(OperatePackagingSitesPage, false)
          .success
          .value
          .set(StartDatePage, startDate)
          .success
  ...
  val userAnswersWithAllNo = emptyUserAnswers
    ...
    .success
    .value
    .set(HowManyLitresGloballyPage, Small)
    .success
    .value
    .set(ThirdPartyPackagersPage, true)
    .success
  ...
  def validatePanel(panel: Element) = {
    ...
    panel
      .getElementsByClass("govuk-panel__body")
      .text() mustEqual s"We have received your application to register Super Lemonade Plc for the Soft Drinks Industry Levy"
  }
  ...
  def validateSummaryContent(document: Document) = {
    ...
    document
      .getElementById("whatNextTextP2")
      .text() mustEqual s"We will send your Soft Drinks Industry Levy reference number to ${contactDetails.email} within 24 hours."

    document.getElementById("needHelp").text() mustEqual "Help using this service"
    document
      .getElementById("needHelpP1")
      .text() mustEqual "Call the Soft Drinks Industry Helpline on 0300 200 1000 if you:"
  ...
  def validateBusinessDetailsSummaryList(
    summaryList: Element,
    utr: String,
    address: UkAddress,
    ...
    addressRow
      ...
      .text() mustBe s"${address.lines.mkString(" ")} ${address.postCode}"
    if (isCheckAnswers) {
      ...
      addressAction
        .getElementById("change-businessAddress")
        .attr("href") mustBe "/soft-drinks-industry-levy-registration/change-verify"
    } else {
    ...
    globalLitresRow
      ...
      .text() mustBe "Litres of your own brands of liable drinks packaged globally in the past 12 months"
    ...
    if (isCheckAnswers) {
      ...
      globalLitresAction
        .text() mustBe "Change litres of your own brands of liable drinks packaged globally in the past 12 months"
      globalLitresAction
        .getElementById("change-howManyLitresGlobally")
        .attr("href") mustBe "/soft-drinks-industry-levy-registration/change-how-many-litres-globally"
    } else {
  ...
  def validateThirdPartyPackersSummaryList(thirdPartyPackerElem: Element, isCheckYourAnswers: Boolean) = {
    ...
    if (isCheckYourAnswers) {
      yesNoRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change if you use any third parties in the UK to package liable drinks on your behalf"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "if you use any third parties in the UK to package liable drinks on your behalf"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
  ...
  def validateOperatePackagingSitesWithLitresSummaryList(
    operatePackagingSites: Element,
    ...
    if (isCheckYourAnswers) {
      yesNoRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change do you operate any packaging sites in the UK to package liable drinks for the brands you own?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "do you operate any packaging sites in the UK to package liable drinks for the brands you own?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
        .first()
        .attr("href") mustBe routes.OperatePackagingSitesController.onPageLoad(CheckMode).url
    } else {
      yesNoRow.getElementsByClass("govuk-summary-list__actions").size() mustBe 0
    }

    lowBandRow.getElementsByClass("govuk-summary-list__value").first().text() mustBe java.text.NumberFormat.getInstance
      .format(litresInBands.lowBand)
    if (isCheckYourAnswers) {
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in low band for own brands packaged at your own site"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in low band for own brands packaged at your own site"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
        .first()
        .attr("href") mustBe routes.HowManyOperatePackagingSitesController.onPageLoad(CheckMode).url
    } else {
      lowBandRow.getElementsByClass("govuk-summary-list__actions").size() mustBe 0
    }

    highBandRow.getElementsByClass("govuk-summary-list__value").first().text() mustBe java.text.NumberFormat.getInstance
      .format(litresInBands.highBand)
    if (isCheckYourAnswers) {
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in high band for own brands packaged at your own site"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in high band for own brands packaged at your own site"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
  ...
  def validateOperatePackagingSitesWithNoLitresSummaryList(
    operatePackagingSites: Element,
    isCheckYourAnswers: Boolean
  ) = {
    val rows     = operatePackagingSites.getElementsByClass("govuk-summary-list__row")
  ...
  def validateContractPackingWithLitresSummaryList(
    operatePackagingSites: Element,
    litresInBands: LitresInBands,
    isCheckYourAnswers: Boolean
  ) = {
    ...
    if (isCheckYourAnswers) {
      yesNoRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change do you operate any packaging sites in the UK to package liable drinks as a third party or contract packer?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "do you operate any packaging sites in the UK to package liable drinks as a third party or contract packer?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
    ...
    if (isCheckYourAnswers) {
      lowBandRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in low band for contract packed at your own site"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in low band for contract packed at your own site"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
    ...
    if (isCheckYourAnswers) {
      highBandRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in high band for contract packed at your own site"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in high band for contract packed at your own site"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
  ...
  def validateContractPackingWithNoLitresSummaryList(operatePackagingSites: Element, isCheckYourAnswers: Boolean) = {
    val rows     = operatePackagingSites.getElementsByClass("govuk-summary-list__row")
    rows.size() mustBe 1
    val yesNoRow = rows.get(0)
    yesNoRow.getElementsByClass("govuk-summary-list__value").first().text() mustBe "No"
  ...
  def validateImportsWithLitresSummaryList(
    imports: Element,
    litresInBands: LitresInBands,
    isCheckYourAnswers: Boolean
  ) = {
    ...
    if (isCheckYourAnswers) {
      yesNoRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change do you bring liable drinks into the UK from anywhere outside of the UK?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "do you bring liable drinks into the UK from anywhere outside of the UK?"
      yesNoRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
    ...
    if (isCheckYourAnswers) {
      lowBandRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in low band for brought into the UK"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in low band for brought into the UK"
      lowBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
    ...
    if (isCheckYourAnswers) {
      highBandRow
        ...
        .getElementsByTag("a")
        .first()
        .text() mustBe "Change amount of litres in high band for brought into the UK"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByClass("govuk-visually-hidden")
        .first()
        .text() mustBe "amount of litres in high band for brought into the UK"
      highBandRow
        .getElementsByClass("govuk-summary-list__actions")
        .first()
        .getElementsByTag("a")
  ...
  def validateImportsWithNoLitresSummaryList(imports: Element, isCheckYourAnswers: Boolean) = {
    val rows     = imports.getElementsByClass("govuk-summary-list__row")
    rows.size() mustBe 1
    val yesNoRow = rows.get(0)
    yesNoRow.getElementsByClass("govuk-summary-list__value").first().text() mustBe "No"
  ...
  def validateStartDateSummaryList(
    summaryList: Element,
    ...
    if (isCheckAnswers) {
      ...
      fullNameAction.getElementById("change-startDate").attr("href") mustBe routes.StartDateController
  ...
  def validateSiteDetailsSummary(
    summaryList: Element,
    ...
    def testWarehouseSitesRow(warehouseRow: Element) =
      if (isCheckAnswers) {
        ...
        warehouseRow
          ...
          .getElementsByTag("a")
          .first()
          .text() mustBe "Change the UK warehouses you use to store liable drinks"
        warehouseRow
          .getElementsByClass("govuk-summary-list__actions")
          .first()
          .getElementsByClass("govuk-visually-hidden")
          .first()
          .text() mustBe "the UK warehouses you use to store liable drinks"
        warehouseRow
          .getElementsByClass("govuk-summary-list__actions")
          .first()
          .getElementsByTag("a")
          .first()
          .attr("href") mustBe warehouseLink
      } else {
        warehouseRow.getElementsByClass("govuk-summary-list__actions").size() mustBe 0
      }
  }

  def validateContactDetailsSummaryList(
    summaryList: Element,
    ...
    if (isCheckAnswers) {
      ...
      fullNameAction
        .getElementById("change-fullName")
        .attr("href") mustBe "/soft-drinks-industry-levy-registration/change-contact-details"
    } else {
    ...
    if (isCheckAnswers) {
      ...
      phoneAction
        .getElementById("change-phoneNumber")
        .attr("href") mustBe "/soft-drinks-industry-levy-registration/change-contact-details"
    } else {
