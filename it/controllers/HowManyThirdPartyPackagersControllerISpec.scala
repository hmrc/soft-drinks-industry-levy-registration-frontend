...
class HowManyThirdPartyPackagersControllerISpec extends LitresISpecHelper {

  val normalRoutePath = "/contract-packer-next-12-months"
  val checkRoutePath = "/change-contract-packer-next-12-months"

  val userAnswers = emptyUserAnswers.set(HowManyThirdPartyPackagersPage, litresInBands).success.value
  ...
  List(NormalMode, CheckMode).foreach { mode =>
    ...
    "GET " + path - {
      "when the userAnswers contains no data" - {
        "should return OK and render the litres page for ThirdPartyPackers with no data populated" in {
          given
            .commonPrecondition
          ...
          WsTestClient.withClient { client =>
            ...
            whenReady(result1) { res =>
              ...
              page.title must include(Messages("howManyThirdPartyPackers" + ".title"))
      ...
      testOtherSuccessUserTypes(baseUrl + path, Messages("howManyThirdPartyPackers" + ".title"))
          ...
          "when the session contains no data for page" in {
            ...
            WsTestClient.withClient { client =>
              ...
              whenReady(result) { res =>
                ...
                val dataStoredForPage = getAnswers(userAnswers.id).fold[Option[LitresInBands]](None)(_.get(HowManyThirdPartyPackagersPage))
