...
class RequiredUserAnswers @Inject() (genericLogger: GenericLogger)(implicit val executionContext: ExecutionContext) extends ActionHelpers {
  ...
  private[controllers] def journey: List[RequiredPage[_, _, _]] = {
    ...
    List(
      ...
      RequiredPage(PackAtBusinessAddressPage, List(previousPageSmallOrNonProducer, PreviousPage(ContractPackingPage, List(true))(implicitBoolean)))(implicitBoolean),
      RequiredPage(PackAtBusinessAddressPage, List(
        PreviousPage(HowManyLitresGloballyPage, List(largeProducer))(implicitGlobally),
        PreviousPage(OperatePackagingSitesPage, List(false))(implicitBoolean), PreviousPage(ContractPackingPage, List(true))(implicitBoolean)))(implicitBoolean),
      RequiredPage(PackAtBusinessAddressPage, List(
        PreviousPage(HowManyLitresGloballyPage, List(largeProducer))(implicitGlobally),
        PreviousPage(OperatePackagingSitesPage, List(true))(implicitBoolean), PreviousPage(ContractPackingPage, List(true, false))(implicitBoolean)))(implicitBoolean),
      ...
      RequiredPage(ContactDetailsPage, List(
        ...
        PreviousPage(ContractPackingPage, List(false))(implicitBoolean), PreviousPage(ImportsPage, List(false))(implicitBoolean)))(implicitly[Reads[ContactDetails]]),
