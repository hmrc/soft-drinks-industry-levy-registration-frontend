...
sealed trait HowManyLitresGlobally

object HowManyLitresGlobally extends Enumerable.Implicits {

  case object Large extends WithName("large") with HowManyLitresGlobally
