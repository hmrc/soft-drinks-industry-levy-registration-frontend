...
class FrontendAppConfig @Inject() (configuration: ServicesConfig) {
  ...
  val sdilFrontendBaseUrl: String = s"${configuration.baseUrl("soft-drinks-industry-levy-frontend")}/soft-drinks-industry-levy"
  ...
  val helpdeskPhoneNumber: String = configuration.getString("helpdeskPhoneNumber").replace("-"," ")
}
