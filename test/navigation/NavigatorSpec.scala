  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "must go from a page that doesn't exist in the route map to Index" in {
        ...
        ) mustBe routes.RegistrationController.start
      }
        ...
        "must navigate to cannot register partnership page and partnership is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              ...
              Json.obj(OrganisationTypePage.toString -> Partnership.toString)
            )
          )
        ...
        "must navigate to how many litres globally page and limited company is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(OrganisationTypePage.toString -> LimitedCompany.toString)
            )
          )
        ...
        "must navigate to how many litres globally page and limited liability partnership is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(OrganisationTypePage.toString -> LimitedLiabilityPartnership.toString)
            )
          )
          result mustBe routes.HowManyLitresGloballyController.onPageLoad(NormalMode)
        }
        ...
        "must navigate to how many litres globally page and unincorporated body is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(OrganisationTypePage.toString -> UnincorporatedBody.toString)
            )
          )
          result mustBe routes.HowManyLitresGloballyController.onPageLoad(NormalMode)
        }
        ...
        "must navigate to how many litres globally page and sole trader is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(OrganisationTypePage.toString -> SoleTrader.toString)
            )
          )
          result mustBe routes.HowManyLitresGloballyController.onPageLoad(NormalMode)
        }
        ...
        "must navigate to third party packagers page when less than 1 million litres is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(HowManyLitresGloballyPage.toString -> Large.toString)
            )
          )
        ...
        "must navigate to third party packagers page when less than less than 1 million litres is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(HowManyLitresGloballyPage.toString -> Small.toString)
            )
          )
        ...
        "must navigate to third party packagers page when None is selected" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(HowManyLitresGloballyPage.toString -> HowManyLitresGlobally.None.toString)
            )
          )
        ...
        "must navigate to third party of co-packing in case of valid litreage" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(HowManyOperatePackagingSitesPage.toString -> Json.obj("lowBand" -> "123", "highBand" -> "123"))
            )
          )
          result mustBe routes.ContractPackingController.onPageLoad(NormalMode)
        }
        ...
        "must navigate to imports page in case of valid litreage" in {
          val result = navigator.nextPage(
            ...
            UserAnswers(
              "id",
              RegisterState.RegisterWithAuthUTR,
              Json.obj(HowManyContractPackingPage.toString -> Json.obj("lowBand" -> "123", "highBand" -> "123"))
            )
          )
          result mustBe routes.ImportsController.onPageLoad(NormalMode)
        }
            ...
            val result = navigator.nextPage(
              ...
              UserAnswers(
                ...
                Json.obj(
                  ...
                  "operatePackagingSites" -> false,
                  "contractPacking"       -> false,
                  "imports"               -> false
                )
              )
            )
      ...
      s"when on $ImportsPage when user has answered yes " - {
        s" must navigate to the $HowManyImportsPage page " in {
          val result = navigator.nextPage(
            ...
            NormalMode,
            emptyUserAnswers.copy(data =
              Json.obj("howManyLitresGlobally" -> "small", "contractPacking" -> false, "imports" -> true)
            )
          )
      ...
      s"when on $ImportsPage when user has answered no " - {
        s"as a large producer, must navigate to the $StartDatePage" in {
          val result = navigator.nextPage(
            ...
            NormalMode,
            emptyUserAnswers.copy(data =
              Json.obj("howManyLitresGlobally" -> "large", "contractPacking" -> false, "imports" -> false)
            )
          )
        ...
        s"as a non-producer, if user selected no on $ContractPackingPage, must navigate to the DoNotRegister controller" in {
          val result = navigator.nextPage(
            ...
            NormalMode,
            emptyUserAnswers.copy(data =
              Json.obj("howManyLitresGlobally" -> "xnot", "contractPacking" -> false, "imports" -> false)
            )
          )
          ...
          val result = navigator.nextPage(
            ...
            emptyUserAnswers.copy(data =
              Json.obj(
                ...
                "operatePackagingSites"  -> false,
                "contractPacking"        -> true,
                "howManyContractPacking" ->
                  Json.obj("lowBand" -> 1, "highBand" -> 1),
                "imports"                -> false
              )
            )
          )
          ...
          HowManyLitresGlobally.values.foreach { previousValue =>
            HowManyLitresGlobally.values.foreach { newValue =>
              val userAnswers = UserAnswers(
                "id",
                RegisterState.RegisterWithAuthUTR,
                Json.obj(HowManyLitresGloballyPage.toString -> newValue.toString)
              )
