    ...
    "formatBusinessAddress" - {
      "should place a break after a trading name if a trading name is used" in {
        ...
        val expectedAddressContent = HtmlContent(
          "Test trading name 1<br/>The house<br/>The Road<br/>ugzhkxcajkcjfrqsgkjruzlmsxytwhg vdg" +
      ...
      "should place a break before the post code" in {
        ...
        val expectedAddressContent = HtmlContent(
          "29 Station Rd<br/>The Railyard<br/>Cambridge" +
      ...
      "should place a break before each address line" in {
        ...
        val result                 = AddressFormattingHelper.formatBusinessAddress(address44Characters, None)
        val expectedAddressContent = HtmlContent(
          "29 Station Rd<br/>The Railyard<br/>Cambridge<br/>London" +
            "<br/><span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>"
        )
      ...
      "should not place a break if missing address lines" in {
        ...
        val expectedAddressContent =
          HtmlContent("29 Station Rd<br/><span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>")
    ...
    "address formatting" - {
      "should place a break after a trading name if a trading name is used" in {
        ...
        val expectedAddressContent = Html(
          "Test trading name 1<br>The house, The Road, ugzhkxcajkcjfrqsgkjruzlmsxytwhg vdg," +
      ...
      "should not place a break before the post code if the address line and post code length is 44 characters" in {
        ...
        val expectedAddressContent = Html(
          "Wild Lemonade Group<br>29 Station Rd, The Railyard, Cambridge, <span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>"
        )
      ...
      "should place a break before the post code if the address line and post code length is between 45 and 49 characters" in {
        ...
        val expectedAddressContent45 = Html(
          "Wild Lemonade Group<br>29 Station Pl., The Railyard, Cambridge, <br><span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>"
        )
      ...
      "should not place a break before the post code if the address line and post code length is 50 characters" in {
        ...
        val expectedAddressContent = Html(
          "Wild Lemonade Group<br>29 Station Place Dr, The Railyard, Cambridge, <span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>"
        )
      ...
      "should autowrap and place a break before the post code if the address line and post code length is between 98 & 103 characters no Trading name" in {
        val addressGreaterThan98   = UkAddress(
          List(
            "29 Station Rd",
            "This address will auto wrap but not in postcode",
            "it is 4 lines 103 char",
            "Cambridge"
          ),
          "CB1 2FP"
        )
        ...
        val expectedAddressContent = Html(
          "Wild Lemonade Group<br>29 Station Rd, This address will auto wrap but not in postcode, it is 4 lines 103 char, Cambridge," +
            " <br><span class=\"nowrap\" style=\"white-space: nowrap;\">CB1 2FP</span>"
        )
