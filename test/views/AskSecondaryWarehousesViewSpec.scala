...
class AskSecondaryWarehousesViewSpec extends ViewSpecHelper {
  ...
  "View" - {
    ...
    "should include a legend with the expected heading" in {
      ...
      legend.get(0).getElementsByClass(Selectors.heading).text() mustEqual Messages("askSecondaryWarehouses.heading")
    }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("askSecondaryWarehouses.title")
