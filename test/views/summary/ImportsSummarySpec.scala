    ...
    s"when the litres is populated in the subscription" - {
      "should return a summary list with Yes and the number of litres" - {
        "with actions when isCheckAnswers" in {
          ...
          rows.head.actions.head.items.head.href must include("/change-imports")
          ...
          rows(1).actions.head.items.head.href must include("/change-how-many-imports-next-12-months")
          ...
          rows(2).actions.head.items.head.href must include("/change-how-many-imports-next-12-months")
