...
class ImportsSummarySpec extends RegistrationSubscriptionHelper {
    ...
    s"when the litres is populated in the subscription" - {
      "should return a summary list with Yes and the number of litres" - {
        "with actions when isCheckAnswers" in {
          ...
          rows.head.actions.head.items.head.href mustBe "/soft-drinks-industry-levy-registration/change-imports"
          rows.head.actions.head.items.head.attributes mustBe Map("id" -> "change-imports")
          ...
          rows(1).actions.head.items.head.href mustBe "/soft-drinks-industry-levy-registration/change-how-many-imports-next-12-months"
          rows(1).actions.head.items.head.attributes mustBe Map("id" -> "change-litresInLowBand-litreage-imports")
          ...
          rows(2).actions.head.items.head.href mustBe "/soft-drinks-industry-levy-registration/change-how-many-imports-next-12-months"
          rows(2).actions.head.items.head.attributes mustBe Map("id" -> "change-litresInHighBand-litreage-imports")
