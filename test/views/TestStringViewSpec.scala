...
class TestStringViewSpec extends ViewSpecHelper {
  ...
  "View" - {
    ...
    "contains a form with the correct action" - {
      "when in CheckMode" in {
        ...
        documentAllSelected.select(Selectors.form)
          .attr("action") mustEqual routes.TestStringController.onSubmit(CheckMode).url
      }
      ...
      "when in NormalMode" in {
        ...
        documentAllSelected.select(Selectors.form)
          .attr("action") mustEqual routes.TestStringController.onSubmit(NormalMode).url
      }
    }
    ...
    "when a form error exists" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("testString.title")
