...
object $className$Summary extends RegisterDetailsSummaryListWithLitres  {
  ...
  override val summaryLitres: SummaryListRowLitresHelper = HowMany$className$Summary
  override val key: String = "reporting$className;format="decap"$"
  override val action: String = routes.$className$Controller.onPageLoad(CheckMode).url
  override val actionId: String = "change-$className;format="decap"$"
  override val hiddenText: String = "$className;format="decap"$"
